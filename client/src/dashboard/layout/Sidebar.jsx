...
import logo from "../../assets/onebyone.png";
    ...
    return (
        <div className='w-[250px] h-screen fixed left-0 top-0 bg-white'>
            <div className="h-[120px] flex justify-center items-center">
                <Link to='/'>
                    <img className='w-[150px] h-[105px]' src={logo} alt="" />
                </Link>
            </div>
            <ul className='px-3 flex flex-col gap-y-1 font-medium'>
                {
                    store.userInfo?.role === 'superadmin' ? (<>
                        <li>
                            <Link to='/dashboard/superadmin' className={`px-3 ${pathname === '/dashboard/superadmin' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><AiFillDashboard /></span>
                                <span>Dashboard</span>
                            </Link>
                        </li>
                        <li>
                            <Link to='/dashboard/admin/add' className={`px-3 ${pathname === '/dashboard/admin/add' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><FiUsers /></span>
                                <span>Add Admin</span>
                            </Link>
                        </li>
                        <li>
                            <Link to='/dashboard/admins' className={`px-3 ${pathname === '/dashboard/admins' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><FiUsers /></span>
                                <span>Admins</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to='/dashboard/advertisers' className={`px-3 ${pathname === '/dashboard/advertisers' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><FiUsers /></span>
                        ...
                        <li>
                            <Link to='/dashboard/advertiser/add' className={`px-3 ${pathname === '/dashboard/advertiser/add' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><AiOutlinePlus /></span>
                        ...
                        <li>
                            <Link to='/dashboard/advertiser' className={`px-3 ${pathname === '/dashboard/advertiser' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><AiFillDashboard /></span>
                                <span>Dashboard</span>
                            </Link>
                        </li>
                        <li>
                            <Link to='/dashboard/advertisement/create' className={`px-3 ${pathname === '/dashboard/advertisement/create' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                                <span className='text-xl'><FaPlus /></span>
                ...
                <li>
                    <Link to='/dashboard/advertisement' className={`px-3 ${pathname === '/dashboard/advertisement' ? 'bg-indigo-500 text-white' : 'bg-white text-[#404040f6]'} py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white`}>
                        <span className='text-xl'><BiNews /></span>
