  ...
  return (
    <div className="bg-white shadow">
      <div className="group relative overflow-hidden">
        {/* Make sure the parent container of Image has relative position and height */}
        <div
          style={{ height: `${height}px`, position: 'relative' }} // Ensure position relative
          className="w-full group-hover:scale-[1.1] transition-all duration-[1s]"
        >
          <Image
            className="object-cover" // Add object-cover to ensure image fits properly
            layout="fill"
            src={news?.image}
            alt="image"
          />
